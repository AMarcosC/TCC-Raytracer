...
- Dados do exemplo:
    - Modelo: telhado simples, separado entre o modelo tridimensional do telhado (Telhado-Telhado.obj)
    e o modelo tridimensional do resto da casa, nesse caso, basicamente, as paredes (Telhado-Parede.obj)
...
change_to_current_dir()  #muda o diretório atual onde o código está sendo executado - método 02 (só reforçar)
...
for time in sunpath:
    cont = cont+1
    print("----- Etapa {} de {} --- El: {} Az: {} ---".format(cont,len(sunpath),time[0],time[1]))
